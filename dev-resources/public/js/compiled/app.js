window.CLOSURE_UNCOMPILED_DEFINES = {"figwheel.repl.connect_url":"ws:\/\/localhost:9500\/figwheel-connect?fwprocess=a279be&fwbuild=dev"};
...
document.write('<script>goog.require("user.dev");</script>');
